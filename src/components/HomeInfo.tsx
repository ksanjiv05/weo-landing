...
export default function HomeInfo({ id,hideHomeinfo, showHomeInfo }: IHomeInfoProps) {
  ...
  React.useEffect(() =>{setInView(showHomeInfo)},[showHomeInfo])
  return (
    <section ref={ref}>
      <motion.div
        ...
        className="h-screen w-screen flex flex-col justify-between bg-transparent"
      >
        ...
        <footer className="flex items-center justify-between">
          <div className="w-52 h-16  flex bg-black items-center " style={{display:"none"}}>
            <motion.div
