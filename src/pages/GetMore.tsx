...
const OLogo = () => {
    ...
    return <div className='flex-1 p-4 flex items-start  justify-center  max-sm:justify-center'>
        <div className='h-52 w-52 absolute bg-white rounded-full shadow-[inset_0_0px_16px_rgba(0,0,0,0.45)] flex items-center justify-center'>
            <div className='h-40 w-40 absolute rounded-full border-2 flex justify-center' style={{ backgroundColor: COLORS.BOTTOM_COLOR }}>
                ...
                <div onMouseEnter={() => router.push("/")} className='h-12 w-12 absolute bg-white rounded-full flex items-center justify-center top-8'>
                    <div className='h-8 w-8 absolute rounded-full border-2 flex items-center justify-center' style={{ backgroundColor: COLORS.BOTTOM_COLOR }}>
                    </div>
                </div>
            </div>
        </div>
...
export default function GetMore(props: IGetMoreProps) {
    ...
    return (<div style={{ overflow: "hidden" }}>
        <motion.div
            ...
            variants={variants}
            initial='hidden'
            className='flex flex-col h-screen max-sm:flex-col opacity-0 scale-50' style={{ backgroundColor: COLORS.BOTTOM_COLOR, }}>
            ...
            <div className='flex-1 p-4 flex-row max-sm:flex-row flex max-sm:block'>
                <div className='flex-1 flex items-end flex-col '>
                    <div className='flex-1 flex items-end  max-sm:items-center max-sm:justify-center'>
                        <h1 className=' text-8xl font-bold' style={{ color: "#ffffff4a" }} >get more</h1>
                    </div>
